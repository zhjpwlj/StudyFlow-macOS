...
import { Play, Square, Clock, CalendarDays, Tag } from 'lucide-react';
      ...
      <div className="p-4 border-b border-white/20 dark:border-black/20 flex-shrink-0">
        <form onSubmit={handleStart} className="flex flex-col md:flex-row gap-3 items-center bg-white/50 dark:bg-slate-700/50 p-3 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={activeTimer ? onStopTimer : handleStart} disabled={!activeTimer && !description.trim()} className={`${activeTimer ? 'bg-red-500' : 'bg-indigo-600'} text-white p-3 rounded-lg disabled:opacity-50`}>
